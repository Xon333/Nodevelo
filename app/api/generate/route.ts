...
export async function POST(req: Request) {
  ...
  try {
    ...
    const signals = resolveCoachSignals(sync, athleteModel, baselines, blockSettings.acwrBands, blockSettings.athleteStateWeights, new Date().toISOString().slice(0, 10), profile.performance.ftp);
