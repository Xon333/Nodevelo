...
| **Adaptive self-directed coach — Phase 3b** | Curated-interval HR/cadence/gradient/VAM context for self-directed intent-matching (label-first match, gradient+VAM always attached as evidence). Design + implementation plan written 2026-08-12, revised through two rounds of external review — all findings resolved, implementation-ready. Compound-terrain gap flagged for a future scoping session: a lap with both a climb and a descent inside it isn't detected as either. | [plan](docs/superpowers/plans/2026-08-12-adaptive-coach-p3b-interval-context.md) · [design](docs/superpowers/specs/2026-08-12-adaptive-coach-p3b-interval-context-design.md) · [rough edge](docs/systems/02-scoring-and-learning.md#known-rough-edges) |
