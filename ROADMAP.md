...
| **Adaptive self-directed coach — Phase 3b** | Curated-interval HR/cadence/gradient/VAM context for self-directed intent-matching (label-first match, gradient+VAM always attached as evidence). Implemented and live-smoke-tested 2026-08-13, Claude-reviewed, merging. Two terrain-matching gaps flagged for a future scoping session: (1) a lap with both a climb and a descent inside it isn't detected as either; (2) gradient-fallback matching can match the whole ride as "the climb" when a ride has no meaningfully-segmented curated intervals, over-rewarding the duration mismatch instead of flagging it. | [plan](docs/superpowers/plans/2026-08-12-adaptive-coach-p3b-interval-context.md) · [design](docs/superpowers/specs/2026-08-12-adaptive-coach-p3b-interval-context-design.md) · [rough edges](docs/systems/02-scoring-and-learning.md#known-rough-edges) |
