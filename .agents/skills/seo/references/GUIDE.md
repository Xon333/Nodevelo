...
Use current Google Search documentation to establish requirements; this guide does not assign numerical weights to ranking factors.
...
[`llms.txt`](https://llmstxt.org/) is a proposed convention (a Markdown index of your site's important pages, served at `/llms.txt`) for LLMs to consume. Verify current vendor support before treating it as useful; avoid reorganizing content around unverified benefits.
